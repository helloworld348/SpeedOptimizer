...
namespace Helloworld\SpeedOptimizer\Plugin;
...
use Helloworld\SpeedOptimizer\Helper\Data;
...
class SpeedOptimizer extends \Magento\Framework\View\Element\Template
{
    ...
    public function addLazyLoadJs( $content, $selector='img', $exclude='.loaded' )
    {
        ...
        $script = '<script type="text/javascript"> require(["jquery", "Helloworld/lazyload", "domReady!"], function($, lazyload){$(' . $selector .').not("' . $exclude . '").lazyload();});</script>';
    ...
    public function addLoading($content)
    {
        ...
        $loadingBody = $loadingBody ? $mediaUrl . 'Helloworld/speedoptimizer/' . $loadingBody : $placeholder;
        ...
        $loadingImg  = $loadingImg ?  $mediaUrl . 'Helloworld/speedoptimizer/' . $loadingImg : $placeholder;
